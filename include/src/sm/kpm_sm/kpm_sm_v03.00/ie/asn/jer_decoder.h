 ...
 */
asn_dec_rval_t jer_decode_kpm_v3_00(
 ...
 * Used by more specialized functions, such as OCTET_STRING_decode_jer_utf8_kpm_v3_00
 * and others. This function should not be used by applications, as its API
 * is subject to changes.
 */
asn_dec_rval_t jer_decode_kpm_v3_00_general(
    const asn_codec_ctx_t *opt_codec_ctx,
...
ssize_t jer_next_token_kpm_v3_00(int *stateContext,
 ...
 */
typedef enum jer_check_sym_kpm_v3_00 {
...
} jer_check_sym_kpm_v3_00_e;
jer_check_sym_kpm_v3_00_e jer_check_sym_kpm_v3_00(const void *buf_ptr, int size,
		const char *need_key);
 ...
 */
size_t jer_whitespace_span_kpm_v3_00(const void *chunk_buf, size_t chunk_size);

/*
 * Skip the series of anticipated extensions.
 */
int jer_skip_unknown_kpm_v3_00(jer_check_sym_kpm_v3_00_e scv, ber_tlv_len_t *depth);
