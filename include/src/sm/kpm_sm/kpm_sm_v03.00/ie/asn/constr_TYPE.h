...
typedef struct asn_TYPE_operation_s {
    ...
    jer_type_decoder_f *jer_decode_kpm_v3_00r;      /* Generic JER encoder */
    jer_type_encoder_f *jer_encode_kpm_v3_00r;      /* Generic JER encoder */
 ...
 */
int asn_copy_kpm_v3_00(const asn_TYPE_descriptor_t *td, /* ASN.1 type descriptor */
