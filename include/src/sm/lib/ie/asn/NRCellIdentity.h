...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_NRCellIdentity_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_NRCellIdentity_mir_asn_common;
asn_struct_free_f NRCellIdentity_free;
asn_struct_print_f NRCellIdentity_print;
asn_constr_check_f NRCellIdentity_constraint_mir_asn_common;
