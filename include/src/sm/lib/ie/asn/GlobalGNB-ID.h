...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_GlobalGNB_ID_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_GlobalGNB_ID_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_GlobalGNB_ID_1_mir_asn_common[2];
