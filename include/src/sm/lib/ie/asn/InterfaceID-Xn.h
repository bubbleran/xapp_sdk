...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_InterfaceID_Xn_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_InterfaceID_Xn_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_InterfaceID_Xn_1_mir_asn_common[1];
