...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_NR_CGI_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_NR_CGI_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_NR_CGI_1_mir_asn_common[2];
