...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RIC_Style_Name_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_RIC_Style_Name_mir_asn_common;
asn_struct_free_f RIC_Style_Name_free;
asn_struct_print_f RIC_Style_Name_print;
asn_constr_check_f RIC_Style_Name_constraint_mir_asn_common;
