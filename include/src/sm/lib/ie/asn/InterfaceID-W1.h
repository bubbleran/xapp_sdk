...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_InterfaceID_W1_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_InterfaceID_W1_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_InterfaceID_W1_1_mir_asn_common[2];
