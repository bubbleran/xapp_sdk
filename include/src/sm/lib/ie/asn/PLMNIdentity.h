...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_PLMNIdentity_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_PLMNIdentity_mir_asn_common;
asn_struct_free_f PLMNIdentity_free;
asn_struct_print_f PLMNIdentity_print;
asn_constr_check_f PLMNIdentity_constraint_mir_asn_common;
