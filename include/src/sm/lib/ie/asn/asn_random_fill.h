 ...
 */
typedef struct asn_random_fill_mir_asn_common_result_s {
    enum {
...
} asn_random_fill_mir_asn_common_result_t;
typedef asn_random_fill_mir_asn_common_result_t(asn_random_fill_mir_asn_common_f)(
 ...
 */
int asn_random_fill_mir_asn_common(const struct asn_TYPE_descriptor_s *td, void **struct_ptr,
                    size_t approx_max_length_limit);

/*
 * Returns a random number between min and max.
 */
intmax_t asn_random_between_mir_asn_common(intmax_t min, intmax_t max);
