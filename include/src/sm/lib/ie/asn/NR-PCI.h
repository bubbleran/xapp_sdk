...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_NR_PCI_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_NR_PCI_mir_asn_common;
asn_struct_free_f NR_PCI_free;
asn_struct_print_f NR_PCI_print;
asn_constr_check_f NR_PCI_constraint_mir_asn_common;
