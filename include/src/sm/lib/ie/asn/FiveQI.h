...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_FiveQI_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_FiveQI_mir_asn_common;
asn_struct_free_f FiveQI_free;
asn_struct_print_f FiveQI_print;
asn_constr_check_f FiveQI_constraint_mir_asn_common;
