...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_GNB_CU_UE_F1AP_ID_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_GNB_CU_UE_F1AP_ID_mir_asn_common;
...
asn_constr_check_f GNB_CU_UE_F1AP_ID_constraint_mir_asn_common;
