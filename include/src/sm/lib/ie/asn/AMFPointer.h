...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_AMFPointer_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_AMFPointer_mir_asn_common;
asn_struct_free_f AMFPointer_free;
asn_struct_print_f AMFPointer_print;
asn_constr_check_f AMFPointer_constraint_mir_asn_common;
