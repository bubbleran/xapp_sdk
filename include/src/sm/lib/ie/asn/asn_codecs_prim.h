...
asn_struct_free_f ASN__PRIMITIVE_TYPE_free_mir_asn_common;
...
/*
 * A callback specification for the jer_decode_mir_asn_common_primitive() function below.
 */
enum jer_pbd_rval {
...
/*
 * Specific function to decode simple primitive types.
 * Also see jer_decode_mir_asn_common_general() in jer_decode_mir_asn_commonr.h
 */
asn_dec_rval_t jer_decode_mir_asn_common_primitive(
    const asn_codec_ctx_t *opt_codec_ctx,
    const asn_TYPE_descriptor_t *type_descriptor, void **struct_ptr,
