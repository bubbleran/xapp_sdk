...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_GUAMI_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_GUAMI_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_GUAMI_1_mir_asn_common[4];
