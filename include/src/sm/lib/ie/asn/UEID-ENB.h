...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_UEID_mir_asn_common_ENB;
extern asn_SEQUENCE_specifics_t asn_SPC_UEID_ENB_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_UEID_ENB_1_mir_asn_common[5];
