...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_messageType_3_mir_asn_common;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_Interface_MessageID_mir_asn_common;
