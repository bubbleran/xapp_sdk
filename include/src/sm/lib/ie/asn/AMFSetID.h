...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_AMFSetID_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_AMFSetID_mir_asn_common;
asn_struct_free_f AMFSetID_free;
asn_struct_print_f AMFSetID_print;
asn_constr_check_f AMFSetID_constraint_mir_asn_common;
