...
extern asn_TYPE_descriptor_t asn_DEF_OBJECT_IDENTIFIER_mir_asn_common;
extern asn_TYPE_operation_t asn_OP_OBJECT_IDENTIFIER_mir_asn_common;

ssize_t OBJECT_IDENTIFIER__dump_body_mir_asn_common(const OBJECT_IDENTIFIER_t *st,
                                     asn_app_consume_bytes_f *cb,
                                     void *app_key);

#define OBJECT_IDENTIFIER_free ASN__PRIMITIVE_TYPE_free_mir_asn_common

#if !defined(ASN_DISABLE_PRINT_SUPPORT)
asn_struct_print_f OBJECT_IDENTIFIER_print_mir_asn_common;
#endif  /* !defined(ASN_DISABLE_PRINT_SUPPORT) */

#define OBJECT_IDENTIFIER_compare OCTET_STRING_compare_mir_asn_common
#define OBJECT_IDENTIFIER_copy    OCTET_STRING_copy_mir_asn_common

asn_constr_check_f OBJECT_IDENTIFIER_constraint_mir_asn_common;
...
jer_type_decoder_f OBJECT_IDENTIFIER_decode_jer_mir_asn_common;
jer_type_encoder_f OBJECT_IDENTIFIER_encode_jer_mir_asn_common;
...
#define OBJECT_IDENTIFIER_decode_aper OCTET_STRING_decode_aper_mir_asn_common
#define OBJECT_IDENTIFIER_encode_aper OCTET_STRING_encode_aper_mir_asn_common
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
asn_random_fill_mir_asn_common_f  OBJECT_IDENTIFIER_random_fill_mir_asn_common;
 ...
 * 		int i;
 *
 * 		count = OBJECT_IDENTIFIER_get_arcs_mir_asn_common(oid, arcs, arc_slots);
 ...
 */
ssize_t OBJECT_IDENTIFIER_get_arcs_mir_asn_common(const OBJECT_IDENTIFIER_t *oid,
 ...
 */
int OBJECT_IDENTIFIER_set_arcs_mir_asn_common(OBJECT_IDENTIFIER_t *oid,
 ...
 */
ssize_t OBJECT_IDENTIFIER_parse_arcs_mir_asn_common(const char *oid_text,
 ...
 */
ssize_t OBJECT_IDENTIFIER_get_single_arc_mir_asn_common(const uint8_t *arcbuf,
                                         size_t arcbuf_len,
 ...
 */
ssize_t OBJECT_IDENTIFIER_set_single_arc_mir_asn_common(uint8_t *arcbuf, size_t arcbuf_len,
