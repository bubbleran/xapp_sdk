...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_E_UTRA_ARFCN_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_E_UTRA_ARFCN_mir_asn_common;
asn_struct_free_f E_UTRA_ARFCN_free;
asn_struct_print_f E_UTRA_ARFCN_print;
asn_constr_check_f E_UTRA_ARFCN_constraint_mir_asn_common;
