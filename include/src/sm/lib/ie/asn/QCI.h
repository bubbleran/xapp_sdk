...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_QCI_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_QCI_mir_asn_common;
asn_struct_free_f QCI_free;
asn_struct_print_f QCI_print;
asn_constr_check_f QCI_constraint_mir_asn_common;
