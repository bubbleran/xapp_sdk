...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RANfunction_Name_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_RANfunction_Name_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_RANfunction_Name_1_mir_asn_common[4];
