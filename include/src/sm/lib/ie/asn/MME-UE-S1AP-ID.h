...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_MME_UE_S1AP_ID_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_MME_UE_S1AP_ID_mir_asn_common;
...
asn_constr_check_f MME_UE_S1AP_ID_constraint_mir_asn_common;
