...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_GlobalNgENB_ID_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_GlobalNgENB_ID_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_GlobalNgENB_ID_1_mir_asn_common[2];
