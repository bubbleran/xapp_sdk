...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_EUTRA_CGI_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_EUTRA_CGI_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_EUTRA_CGI_1_mir_asn_common[2];
