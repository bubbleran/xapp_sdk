...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_QosFlowIdentifier_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_QosFlowIdentifier_mir_asn_common;
asn_struct_free_f QosFlowIdentifier_free;
asn_struct_print_f QosFlowIdentifier_print;
asn_constr_check_f QosFlowIdentifier_constraint_mir_asn_common;
