...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_SST_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_SST_mir_asn_common;
asn_struct_free_f SST_free;
asn_struct_print_f SST_print;
asn_constr_check_f SST_constraint_mir_asn_common;
