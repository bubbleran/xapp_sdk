...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_NR_ARFCN_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_NR_ARFCN_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_NR_ARFCN_1_mir_asn_common[1];
