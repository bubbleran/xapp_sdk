...
int get_asn1c_environment_version_mir_asn_common(void);	/* Run-time version */
...
#else	/* !C99 */
void CC_PRINTFLIKE(1, 2) ASN_DEBUG_f_mir_asn_common(const char *fmt, ...);
#define	ASN_DEBUG	ASN_DEBUG_f_mir_asn_common
#endif	/* C99 */
...
asn__format_to_callback_mir_asn_common(
