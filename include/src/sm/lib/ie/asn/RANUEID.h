...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANUEID_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_RANUEID_mir_asn_common;
asn_struct_free_f RANUEID_free;
asn_struct_print_f RANUEID_print;
asn_constr_check_f RANUEID_constraint_mir_asn_common;
