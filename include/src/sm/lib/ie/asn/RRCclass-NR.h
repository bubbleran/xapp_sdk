...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RRCclass_NR_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_RRCclass_NR_mir_asn_common;
extern const asn_INTEGER_specifics_t asn_SPC_RRCclass_NR_specs_1_mir_asn_common;
