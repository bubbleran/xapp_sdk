...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_UEID_mir_asn_common_EN_GNB;
extern asn_SEQUENCE_specifics_t asn_SPC_UEID_EN_GNB_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_UEID_EN_GNB_1_mir_asn_common[6];
