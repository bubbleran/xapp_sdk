...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_AMF_UE_NGAP_ID_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_AMF_UE_NGAP_ID_mir_asn_common;
asn_struct_free_f AMF_UE_NGAP_ID_free;
asn_struct_print_f AMF_UE_NGAP_ID_print;
asn_constr_check_f AMF_UE_NGAP_ID_constraint_mir_asn_common;
