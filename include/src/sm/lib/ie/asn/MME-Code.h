...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_MME_Code_constr_1_mir_asn_common;
extern asn_TYPE_descriptor_t asn_DEF_MME_Code_mir_asn_common;
asn_struct_free_f MME_Code_free;
asn_struct_print_f MME_Code_print;
asn_constr_check_f MME_Code_constraint_mir_asn_common;
