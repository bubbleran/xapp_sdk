...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_S_NSSAI_mir_asn_common;
extern asn_SEQUENCE_specifics_t asn_SPC_S_NSSAI_specs_1_mir_asn_common;
extern asn_TYPE_member_t asn_MBR_S_NSSAI_1_mir_asn_common[2];
