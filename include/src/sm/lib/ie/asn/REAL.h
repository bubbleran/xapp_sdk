...
extern asn_TYPE_descriptor_t asn_DEF_REAL_mir_asn_common;
extern asn_TYPE_operation_t asn_OP_REAL_mir_asn_common;

#define REAL_free ASN__PRIMITIVE_TYPE_free_mir_asn_common

#if !defined(ASN_DISABLE_PRINT_SUPPORT)
asn_struct_print_f REAL_print_mir_asn_common;
#endif  /* !defined(ASN_DISABLE_PRINT_SUPPORT) */

asn_struct_compare_f REAL_compare_mir_asn_common;
asn_struct_copy_f    REAL_copy_mir_asn_common;

#define REAL_constraint asn_generic_no_constraint_mir_asn_common
...
jer_type_decoder_f REAL_decode_jer_mir_asn_common;
jer_type_encoder_f REAL_encode_jer_mir_asn_common;
...
per_type_decoder_f REAL_decode_aper_mir_asn_common;
per_type_encoder_f REAL_encode_aper_mir_asn_common;
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
asn_random_fill_mir_asn_common_f  REAL_random_fill_mir_asn_common;
...
ssize_t REAL__dump_mir_asn_common(double d, int canonical, asn_app_consume_bytes_f *cb, void *app_key);
 ...
 */
int asn_REAL2double_mir_asn_common(const REAL_t *real_ptr, double *d);
int asn_double2REAL_mir_asn_common(REAL_t *real_ptr, double d);
 ...
 */
int asn_double2float_mir_asn_common(double d, float *outcome);
