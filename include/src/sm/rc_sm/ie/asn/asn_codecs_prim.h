...
/*
 * A callback specification for the jer_decode_rc_v1_03_primitive() function below.
 */
enum jer_pbd_rval {
...
/*
 * Specific function to decode simple primitive types.
 * Also see jer_decode_rc_v1_03_general() in jer_decode_rc_v1_03r.h
 */
asn_dec_rval_t jer_decode_rc_v1_03_primitive(
    const asn_codec_ctx_t *opt_codec_ctx,
    const asn_TYPE_descriptor_t *type_descriptor, void **struct_ptr,
