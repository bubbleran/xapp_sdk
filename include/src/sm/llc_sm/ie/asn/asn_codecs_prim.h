...
asn_struct_free_f ASN__PRIMITIVE_TYPE_free_llc_v1_01;
...
/*
 * A callback specification for the jer_decode_llc_v1_01_primitive() function below.
 */
enum jer_pbd_rval {
...
/*
 * Specific function to decode simple primitive types.
 * Also see jer_decode_llc_v1_01_general() in jer_decode_llc_v1_01r.h
 */
asn_dec_rval_t jer_decode_llc_v1_01_primitive(
    const asn_codec_ctx_t *opt_codec_ctx,
    const asn_TYPE_descriptor_t *type_descriptor, void **struct_ptr,
