...
/*
 * Flags used by the jer_encode_llc_v1_01() and (*jer_type_encoder_f), defined below
 */
enum jer_encode_llc_v1_01r_flags_e {
	/* Mode of encoding */
 ...
 * Produces JER output.
 */
asn_enc_rval_t jer_encode_llc_v1_01(const struct asn_TYPE_descriptor_s *type_descriptor,
                          const void *struct_ptr, /* Structure to be encoded */
                          enum jer_encode_llc_v1_01r_flags_e jer_flags,
 ...
 */
int jer_fprint_llc_v1_01(FILE *stream, const struct asn_TYPE_descriptor_s *td,
