...
int get_asn1c_environment_version_llc_v1_01(void);	/* Run-time version */
...
#else	/* !C99 */
void CC_PRINTFLIKE(1, 2) ASN_DEBUG_f_llc_v1_01(const char *fmt, ...);
#define	ASN_DEBUG	ASN_DEBUG_f_llc_v1_01
#endif	/* C99 */
...
asn__format_to_callback_llc_v1_01(
