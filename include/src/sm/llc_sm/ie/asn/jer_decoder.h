 ...
 */
asn_dec_rval_t jer_decode_llc_v1_01(
 ...
 * Used by more specialized functions, such as OCTET_STRING_decode_jer_utf8_llc_v1_01
 * and others. This function should not be used by applications, as its API
 * is subject to changes.
 */
asn_dec_rval_t jer_decode_llc_v1_01_general(
    const asn_codec_ctx_t *opt_codec_ctx,
...
ssize_t jer_next_token_llc_v1_01(int *stateContext,
 ...
 */
typedef enum jer_check_sym_llc_v1_01 {
...
} jer_check_sym_llc_v1_01_e;
jer_check_sym_llc_v1_01_e jer_check_sym_llc_v1_01(const void *buf_ptr, int size,
		const char *need_key);
 ...
 */
size_t jer_whitespace_span_llc_v1_01(const void *chunk_buf, size_t chunk_size);

/*
 * Skip the series of anticipated extensions.
 */
int jer_skip_unknown_llc_v1_01(jer_check_sym_llc_v1_01_e scv, ber_tlv_len_t *depth);
