...
#else
typedef void (asn_random_fill_llc_v1_01_f)(void);
...
asn_outmost_tag_f asn_TYPE_outmost_tag_llc_v1_01;
...
typedef struct asn_TYPE_operation_s {
    ...
    jer_type_decoder_f *jer_decode_llc_v1_01r;      /* Generic JER encoder */
    jer_type_encoder_f *jer_encode_llc_v1_01r;      /* Generic JER encoder */
    oer_type_decoder_f *oer_decoder;      /* Generic OER decoder */
    oer_type_encoder_f *oer_encoder;      /* Canonical OER encoder */
    per_type_decoder_f *uper_decoder;     /* Unaligned PER decoder */
    per_type_encoder_f *uper_encoder;     /* Unaligned PER encoder */
    per_type_decoder_f *aper_decode_llc_v1_01r;     /* Aligned PER decoder */
    per_type_encoder_f *aper_encode_llc_v1_01r;     /* Aligned PER encoder */
    asn_random_fill_llc_v1_01_f *random_fill;       /* Initialize with a random value */
 ...
 */
int asn_fprint_llc_v1_01(FILE *stream, /* Destination stream descriptor */
 ...
 */
int asn_copy_llc_v1_01(const asn_TYPE_descriptor_t *td, /* ASN.1 type descriptor */
